 ...
 ?>
  ...
  <br>&nbsp &nbsp &nbspBUS TICKET RESERVATION PORTAL<br><br>
    ...
    <div class="navbar">
        ...
        <a class="active" href="cancellation.php"><span class="glyphicon glyphicon-remove"></span> Cancellation</a>
      ...
      <div class="title">
      ENTER THE TCKET DETAILS TO CANCEL BOOKING:
      </div>
      <div class="Entries">
        <form class="cancel" action="confirm_cancelation.php" method="POST">
          <div class="row">
            <div class="col-25">
              <label for="tno">Ticket no. :</label><br>
            </div>
            <div class="col-75">
